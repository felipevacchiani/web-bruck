    ...
    <div className="login-split">
      <style>{`
        ...
        .login-hero::before {
          ...
          background: linear-gradient(100deg, rgba(9,11,10,0.88) 0%, rgba(9,11,10,0.55) 45%, rgba(9,11,10,0.25) 100%);
        }
      ...
      {/* Panel izquierdo: hero con foto real de BRUCK */}
      <div className="login-hero">
        <div className="login-hero-content">
          <div style={{ color: '#31AE79', fontWeight: 700, letterSpacing: '0.2em', fontSize: 13, marginBottom: 14 }}>BRUCK</div>
          <h1 style={{ color: '#F5F5F2', fontSize: 44, lineHeight: 1.08, fontWeight: 600, letterSpacing: '-0.02em', margin: 0 }}>
            Optimizamos<br />tu trabajo.
          </h1>
          <p style={{ color: '#B8BDB9', fontSize: 16, lineHeight: 1.5, marginTop: 18, maxWidth: 380 }}>
            <span style={{ color: '#99D0B8' }}>Tecnología, automatización</span> y operaciones para líderes que toman decisiones.
          </p>
          <p style={{ color: '#F5F5F2', fontSize: 13, marginTop: 40, lineHeight: 1.6 }}>
            CONSTRUIMOS <strong style={{ color: '#99D0B8' }}>CONFIANZA</strong>,<br />
            CREAMOS <strong style={{ color: '#99D0B8' }}>SOLUCIONES</strong>.
          </p>
        </div>
      </div>
      ...
      <div className="login-form-side">
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 52, height: 52, borderRadius: 16, background: 'linear-gradient(135deg, #31AE79, #99D0B8)', marginBottom: 14 }}>
              <span style={{ color: '#07120D', fontWeight: 900, fontSize: 22, letterSpacing: 2 }}>B</span>
            </div>
          ...
          {mode === 'login' && (
            <>
              <div style={{ marginBottom: 22 }}>
                <div style={{ color: '#121714', fontSize: 19, fontWeight: 600, marginBottom: 3 }}>Iniciar sesión</div>
                <div style={{ color: '#4E5651', fontSize: 14 }}>Ingresá tus credenciales para continuar.</div>
              </div>
              ...
              <form onSubmit={handleLogin}>
                <div style={{ marginBottom: 14 }}>
                  ...
                  <input
                    ...
                    style={{ ...inputStyle, width: '100%', color: '#121714', fontSize: 14, borderRadius: 12, padding: '12px 14px', boxSizing: 'border-box' }}
                ...
                <div style={{ marginBottom: 22 }}>
                  ...
                  <div style={{ position: 'relative' }}>
                    <input
                      ...
                      placeholder="••••••••"
                      style={{ ...inputStyle, width: '100%', color: '#121714', fontSize: 14, borderRadius: 12, padding: '12px 42px 12px 14px', boxSizing: 'border-box' }}
                      onFocus={e => e.currentTarget.style.borderColor = '#31AE79'}
                      onBlur={e => e.currentTarget.style.borderColor = 'rgba(18,23,20,0.14)'}
                    />
                ...
                <button type="submit" disabled={loading}
                  style={{ width: '100%', background: loading ? '#7fc4a3' : 'linear-gradient(135deg, #31AE79, #27a06d)', color: '#07120D', fontWeight: 600, fontSize: 15, padding: '13px', borderRadius: 999, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.8 : 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ...
              <div style={{ marginTop: 18, textAlign: 'center' }}>
                <button type="button" onClick={() => { setMode('forgot'); setError('') }}
                  style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#31AE79', fontSize: 13, display: 'inline-flex', alignItems: 'center', gap: 5 }}>
          ...
          {mode === 'forgot' && (
            <>
              ...
              {!forgotSent ? (
                <>
                  <div style={{ marginBottom: 22 }}>
                    <div style={{ color: '#121714', fontSize: 19, fontWeight: 600, marginBottom: 3 }}>Recuperar contraseña</div>
                    <div style={{ color: '#4E5651', fontSize: 14 }}>Te enviamos un link para restablecer tu contraseña.</div>
                  </div>
                  ...
                  <form onSubmit={handleForgotPassword}>
                    ...
                    <button type="submit" disabled={loading}
                      style={{ width: '100%', background: 'linear-gradient(135deg, #31AE79, #27a06d)', color: '#07120D', fontWeight: 600, fontSize: 15, padding: 13, borderRadius: 999, border: 'none', cursor: 'pointer', opacity: loading ? 0.7 : 1 }}>
          ...
          <div style={{ borderTop: '1px solid rgba(18,23,20,0.08)', marginTop: 32, paddingTop: 18 }}>
            <div style={{ color: '#858C87', fontSize: 11, textAlign: 'center' }}>
